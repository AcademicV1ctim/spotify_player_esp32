...
void displayTrackInfo(const char* song, const char* artist) {
  ...
  // Draw a progress bar below the track info.
...
// -------------------------
// Wi-Fi and mDNS Setup using WiFiManager
void connectToWiFi() {
  // Initialize WiFiManager
  WiFiManager wifiManager;
  wifiManager.setDebugOutput(true);
  // This will start an AP (e.g., "ESP32_AP") if no saved WiFi credentials are found.
  // The second parameter is the AP password. Set it to NULL if you want an open AP.
...
void setup() {
  ...
  // Use WiFiManager to manage WiFi and start an AP if needed.
  connectToWiFi();
